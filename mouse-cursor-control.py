...
while True:
    ...
    if INPUT_MODE:
        ...
        direction = utils.get_direction(nose_point, ANCHOR_POINT, w, h)
        cv2.putText(frame, direction.upper(), (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, RED_COLOR, 2)
